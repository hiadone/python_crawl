...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://maisondemiu.co.kr'
		...
		self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage.wow.fadeInDown > div > ul > li'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div.inner.mold > div.xans-element-.xans-product.xans-product-detail.wow.fadeInDown > div.detailArea > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
			...
			# 제품 상세 부분
			#detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#prdDetail > div.cont', '', 'src' )
			detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#prdDetail > div.cont', '', 'ec-data-src' )
