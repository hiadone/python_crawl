...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.dugroo.com'
		...
		self.C_CATEGORY_VALUE = '#header > div > div.topArea > div.gnb > ul > li > ul > li > a'
		self.C_CATEGORY_IGNORE_STR = ['PAYMENT(개인결제창)' ]
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'product-image1'
	...
	def web_process_category_list_second(self):
		...
		try :
			...
			self.WEB_CATEGORY_NAME_HASH['PET'] = ''
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			if( 0 < product_data.crw_name.find('[품절]') ) or ( 0 < product_data.crw_name.find('-품절-') ) : product_data.crw_is_soldout = 1
