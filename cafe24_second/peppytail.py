...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://peppytail.com/page/product.html'
		
		self.ORG_SITE_HOME = 'http://peppytail.com'
		...
		self.C_CATEGORY_VALUE = '#wrapper > div > div > a'
		self.C_CATEGORY_IGNORE_STR = ['Company', '정기배송', 'Gallery', 'Community', 'Contact']
		...
		self.C_PRODUCT_VALUE = '#contents > div > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li'
