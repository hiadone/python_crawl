...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://noashop.co.kr'
		...
		self.C_CATEGORY_VALUE = '#header_wrap > div.inner > div.leftcate > nav > div > ul > li.xans-record-on.xans-record- > a'
		...
		self.C_PRODUCT_VALUE = '#shop_wrap > div.shop_productwrap > div.xans-element-.xans-product.xans-product-normalpackage > div > ul > li'
		...
		self.C_LAST_PAGE_VALUE = '#shop_wrap > div.shop_productwrap > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > a.last'
