...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'https://www.see-kitchen.com'
		...
		self.C_CATEGORY_VALUE = '#header > div.topMenu > div > div > ul > li > a'
		
		self.C_CATEGORY_IGNORE_STR = ['About 씨스루 키친', 'Class 클래스', 'How to SEE KITCHEN', 'Community', '씨스루 푸드', '고객센터']
