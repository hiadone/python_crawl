...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.thesallyslaw.com'
		...
		self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.it-product > ul > li'
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'thumb img_off'
