...
특이사항
	- DOG 카테고리만 수집함. ( http://marlonshop.com/product/list.html?cate_no=255 )
...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://marlonshop.com'
		...
		self.C_CATEGORY_VALUE = '#wrap > header > div > div.bottomHeader > div.bottom.left > div > div > ul > li > a'
		self.C_CATEGORY_IGNORE_STR = ['New', 'Cat', 'Life', 'Kids']
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div.inner > div > div.detailArea > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
