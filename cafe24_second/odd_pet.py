...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'https://www.odd-pet.com'
		...
		#self.C_CATEGORY_VALUE = '#comment_top > div > div.top_cate.fleft > div > ul > li > a'
	...
	def web_process_category_list_second(self):
		...
		self.WEB_CATEGORY_NAME_HASH['FASHION'] = 1
		self.WEB_CATEGORY_NAME_HASH['WALK'] = 1
		self.WEB_CATEGORY_NAME_HASH['LIVING'] = 1
		self.WEB_CATEGORY_NAME_HASH['TOYS'] = 1
		self.WEB_CATEGORY_NAME_HASH['SET'] = 1
