...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://amor-ange.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['NEW']
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = '-origin'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			# 제품 상세 부분
			detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#-description', 'p', 'ec-data-src' )
