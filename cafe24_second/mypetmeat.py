...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://mypetmeat.com'
		...
		self.C_CATEGORY_VALUE = '#header > div.topMenu > div > div.category > ul.position > li > a'
		self.C_CATEGORY_IGNORE_STR = ['고객센터']
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'prdImg img_zoom'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#prdinfo_fix > div > div > div.xans-element-.xans-product.xans-product-detaildesign > table')
