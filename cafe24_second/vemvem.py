...
class shop(Cafe24) :    
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > div > div.fixOpt_cont > div.fixOpt_option.sb > div.xans-element-.xans-product.xans-product-detaildesign > table')
			...
			tmp_detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#contents > div.xans-element-.xans-product.xans-product-detail.section.conbox.product-wrap > div > div.col.col60.colpadding.floatleft.product-images > ul', '', 'src' )
			detail_page_txt, tmp_detail_page_img = self.get_text_img_in_detail_content_part( soup, '#contents > div.xans-element-.xans-product.xans-product-detail.section.conbox.product-wrap > div > div.col.col40.colpadding.floatright.product-info > div.xans-element-.xans-product.xans-product-additional.product-desc', '', 'ec-data-src' )
			
			for tmp_img in tmp_detail_page_img :
				detail_page_img.append(tmp_img)
