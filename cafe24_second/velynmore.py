...
class shop(Cafe24) :    
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea_all_wrap > div > div > div.infoArea_inner > div.xans-element-.xans-product.xans-product-detaildesign > table')
