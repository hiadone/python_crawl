...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.REFERER_SUB_CATEGORY_STR = 'http://riribubu.cafe24.com/product/list.html?cate_no=24'

		self.SITE_HOME = 'http://riribubu.cafe24.com'
		...
		self.C_CATEGORY_VALUE = '#header > div > div > div.main_category > ul > li.xans-element-.xans-layout.xans-layout-category > ul > li > a'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > p.last > a'
