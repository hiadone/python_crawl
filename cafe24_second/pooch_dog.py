...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.REFERER_SUB_CATEGORY_STR = 'http://www.pooch-dog.com/product/list.html?cate_no=53'
		
		self.SITE_HOME = 'http://www.pooch-dog.com'
		...
		self.C_CATEGORY_VALUE = '#main_menu > li.li_solo.xans-record- > strong > a'
		
		self.C_CATEGORY_IGNORE_STR = ['Wholesale(도매회원전용)']
		...
		self.C_PAGE_VALUE = '#paging > ol > li > a'
		...
		self.C_PRODUCT_VALUE = '#mold > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li'
		...
		self.C_LAST_PAGE_VALUE = '#paging > p.last > a'
