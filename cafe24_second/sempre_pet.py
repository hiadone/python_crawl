...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://sempre-pet.com'
		...
		self.C_CATEGORY_VALUE = '#header > div > div.category_llist > ul > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal > ul > div > div'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			crw_post_url = self.set_product_name_url_fourth( product_data, product_ctx , 'ul', 'item_name')
