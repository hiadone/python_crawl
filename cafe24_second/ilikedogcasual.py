...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.ilikedogcasual.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['ONLYYOU']
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			'''
			table_list = soup.select('#contents > div.xans-element-.xans-product.xans-product-detail > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
