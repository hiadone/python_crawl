...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.C_LAST_PAGE_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > a'
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'mainrecoment-1-1'
