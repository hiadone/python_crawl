...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://nixen.co.kr'
		...
		self.C_CATEGORY_VALUE = '#left_cate > div > ul > li > a'
		self.C_CATEGORY_IGNORE_STR = ['회사소개']
		...
		self.C_PAGE_VALUE = '#contents_sub > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > ol > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents_sub > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li'
		...
		self.C_LAST_PAGE_VALUE = '#contents_sub > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > a.last'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			# 품절여부 확인
			#
			# <div class="sold"><img src="/web/upload/icon_201709051101436600.gif" class="icon_img" alt="" title=""></div>
			soldout_div_ctx = product_ctx.find('div', class_='sold')
			if( soldout_div_ctx != None ) : 
				soldout_img_ctx = soldout_div_ctx.find('img')
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			# 제품 상세 부분			
			self.get_cafe24_text_img_in_detail_content_part( soup, product_data, '#icontab_one > div.cont', '' )
