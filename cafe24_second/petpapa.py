...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://petpapa.co.kr'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div.xans-element-.xans-product.xans-product-detail > div.infoTop > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
