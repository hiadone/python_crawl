...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://withtory.com'
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'prd_tmb'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			crw_post_url = self.set_product_name_url_fifth( product_data, product_ctx , 'div', 'prd_name')
