...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://bokseul.com'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			#
			# <p class="prdImg">
			# <a href="/product/detail.html?product_no=97&amp;cate_no=50&amp;display_group=1" name="anchorBoxName_97"><img src="//bokseul.com/web/product/medium/202007/cb96bcf84612e722c677a8be692a6724.jpg" id="eListPrdImage97_1" alt="죽 5EA_10%할인(회원전용)" class="thumb"></a>
