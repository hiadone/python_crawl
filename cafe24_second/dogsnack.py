...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://dogsnack.kr'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			# 상품 이미지 확인
			#
			# <a href="/product/detail.html?product_no=142&amp;cate_no=55&amp;display_group=1" name="anchorBoxName_142"><img src="//cokemill.com/web/product/medium/201810/be20e9b9a3981ddfea24803c128c21ad.jpg" alt="" class="thumb"></a>
			###########################
			...
			#
			# <p class="name">
			# <a href="/product/detail.html?product_no=144&amp;cate_no=55&amp;display_group=1"><span style="font-size:12px;color:#555555;">HOT!!!!시나몬라떼 니트조끼(카멜)</span></a><br><span class="zoom"><img src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/btn_prd_zoom.gif" onclick="zoom('144', '55', '1','', '');" style="cursor:pointer" alt="상품 큰 이미지 보기"></span>
			# </p>
			###########################

			crw_post_url = self.set_product_name_url_third( product_data, product_ctx , 'p', 'name')
			if(crw_post_url == '') : crw_post_url = self.set_product_name_url_third( product_data, product_ctx , 'strong', 'name')
