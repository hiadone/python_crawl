...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'https://www.cherpetit.co.kr'
		...
		self.C_CATEGORY_VALUE = '#snb > div > div > ul > li > a'
		...
		self.C_PAGE_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpaging.romi_paging > ol > li > a'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpaging.romi_paging > p > a'
	...
	def web_get_category_data_second(self, html):
		return self.web_get_category_data_second_in_img(html)
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			# 가격
			#
			# <ul class="xans-element- xans-product xans-product-listitem"><li class=" xans-record-"><span style="font-size:12px;color:#555555;text-decoration:line-through;">₩20,000</span></li>
			# <li class=" xans-record-"><span style="font-size:12px;color:#000000;font-weight:bold;">₩18,000</span><span id="span_product_tax_type_text" style=""> </span></li>
			# <li class=" xans-record-"><span style="font-size:12px;color:#555555;">₩1,636</span></li>
			# </ul>
			##############################
			...
			for li_ctx in li_list :
				...
				if(span_ctx != None ) :
					...
					if('style' in span_ctx.attrs ) and (0 <= value_str.find('₩')) :
						span_style = span_ctx.attrs['style']
						if( 0 < span_style.find('line-through;') ) : product_data.crw_price = int( __UTIL__.get_only_digit( value_str ) )
						elif( 0 < span_style.find('bold;') )  : product_data.crw_price_sale = int( __UTIL__.get_only_digit( value_str ))
