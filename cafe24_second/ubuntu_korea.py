...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.ubuntu-korea.com'
		...
		self.C_CATEGORY_VALUE = '#wrap > header > div > div.mRight > div > div > div > ul > li > ul.xans-element-.xans-layout.xans-layout-category.sub-title > li > a'
