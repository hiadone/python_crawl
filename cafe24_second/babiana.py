...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage > div > ul.prdList > li'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpaging > p > a'
		...
		# <p class="name"><a href="/product/detail.html?product_no=437&amp;cate_no=42&amp;display_group=1" class="name"><span style="font-size:12px;color:#555555;font-weight:bold;">프리미엄워싱 그린&amp;먹색침구</span></a> <img src="//img.echosting.cafe24.com/design/skin/admin/ko_KR/ico_product_soldout.gif" class="icon_img" alt="품절">   </p>
		#
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#prdInfo > table')
