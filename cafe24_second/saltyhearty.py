...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'https://saltyhearty.com'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			# 가격
			# <li class="price_all">
			# <span class="custom displaynone">0원</span>
			# <span class="price  displaynone"><span class="strike">3,000원</span><span class="pri">3,000원</span></span>
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#itemArea > div > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
