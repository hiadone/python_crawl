...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://j-o-yi.com'
		...
		self.C_PAGE_VALUE = '#wrap > div > div.inner > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > ol > li > a'
		...
		self.C_PRODUCT_VALUE = '#wrap > div > div.inner > div.xans-element-.xans-product.xans-product-normalpackage > div > ul> li'
		...
		self.C_LAST_PAGE_VALUE = '#wrap > div > div.inner > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > a.last'
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			# 품절여부 확인
			# 상품명에 품절이라고 표시함
			# <strong class="name"><a href="/product/detail.html?product_no=154&amp;cate_no=54&amp;display_group=1" class=""><span class="title displaynone"><span style="font-size:13px;color:#1c1c1c;font-weight:bold;">상품명</span> :</span> <span style="font-size:13px;color:#1c1c1c;font-weight:bold;">(품절) Hanbok Embroidery Cape - Navy</span></a></strong>

			if(0 <= product_data.crw_name.find('(품절)') ) : product_data.crw_is_soldout = 1
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#wrap > div > div.inner > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
