...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.REFERER_SUB_CATEGORY_STR = 'https://lovehotfit.com/product/list.html?cate_no=163'
		
		self.SITE_HOME = 'https://lovehotfit.com/product/list.html?cate_no=163'
		
		self.ORG_SITE_HOME = 'https://lovehotfit.com'
		...
		self.C_CATEGORY_VALUE = '#subcate > ul > li > a'
		self.C_CATEGORY_IGNORE_STR = ['Only you', 'ONLY YOU']
		...
		self.C_PAGE_VALUE = '#listcontent > div.xans-element-.xans-product.xans-product-normalpaging.ga09-paging > ol > li > a'
		...
		self.C_PRODUCT_VALUE = '#listcontent > div.xans-element-.xans-product.xans-product-listnormal.ga09list > ul > li > div'
		...
		self.C_LAST_PAGE_VALUE = '#listcontent > div.xans-element-.xans-product.xans-product-normalpaging.ga09-paging > a.last'
		...
		self.C_PRODUCT_IMG_SELECTOR_CLASSNAME = 'ga09img'
	...
	'''
	# Web Category Name : FASHION
	# SubCategory Name : Fashion
	# 으로 불일치 발생, 첫번째 문자를 제외하고 소문자로 변환
	'''
	...
	def set_product_data(self , page_url, soup, product_ctx ) :
		...
		try :
			...
			soldout_img_ctx = product_ctx.find('img', class_='ec-admin-icon cart')
