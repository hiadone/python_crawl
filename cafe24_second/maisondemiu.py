...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.C_CATEGORY_VALUE = '#wrap > header > div.category-box > div > ul.xans-element-.xans-layout.xans-layout-category.s-title > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div > div > ul.prdList > li'
