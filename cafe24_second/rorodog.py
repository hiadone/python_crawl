...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.REFERER_SUB_CATEGORY_STR = 'http://rorodog.com/index-01.html'
		
		self.SITE_HOME = 'http://rorodog.com/index-01.html'
		
		self.ORG_SITE_HOME = 'http://rorodog.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['gallery', 'ONLYYOU']
