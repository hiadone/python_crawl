...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.merrypongo.com'
		...
		self.C_CATEGORY_VALUE = '#snbL > div.xans-element-.xans-layout.xans-layout-category > div > ul > li > a'
		...
		self.C_PAGE_VALUE = '#container > div.xans-element-.xans-product.xans-product-normalpaging > ol > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-listnormal > ul > li'
		...
		self.C_LAST_PAGE_VALUE = '#container > div.xans-element-.xans-product.xans-product-normalpaging > p > a'
