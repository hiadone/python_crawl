...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://natress.ifupet.com'
		...
		self.C_CATEGORY_VALUE = '#category > div.position > ul > li.xans-record- > a'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div:nth-child(2) > div.detailArea > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
