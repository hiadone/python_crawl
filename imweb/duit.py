...
class shop(ImWeb) :    
	...
	def __init__(self) :
		...
		#self.C_PRODUCT_VALUE = 'body > div > main > div > div > div > div > div > div > div > div > div
		
		self.C_PRODUCT_VALUE = 'body > div > main > div > div > div > div > div > div > div > div > div.shop-item._shop_item'
