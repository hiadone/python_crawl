...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.C_CATEGORY_IGNORE_STR = ['NOTICE','Q&A','REVIEW','EVENT','BLOG','COMMUNITY']
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div > div.xans-element-.xans-product.xans-product-image.imgArea > div.infoArea > div > div.xans-element-.xans-product.xans-product-detaildesign > table')
			...
			detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#prdDetail-1 > div.cont', 'div', 'src' )	
			#detail_page_txt, detail_page_img = self.get_text_img_in_detail_content_part( soup, '#prdDetail-1 > div.cont', 'div', 'ec-data-src' )
