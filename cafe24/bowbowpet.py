...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://bowbowpet.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['knitting__B','ONLY YOU','SALE']
		...
		#self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li > div.description > p > a'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents > div > div > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
...
if __name__ == '__main__':
	...
	#app.set_user_agent()
	#product_data = ProductData()
	#app.process_product_detail( 'http://bowbowpet.com/product/detail.html?product_no=241&cate_no=28&display_group=1', product_data)
