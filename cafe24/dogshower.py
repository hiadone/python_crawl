...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://dogshower.co.kr'
		...
		self.C_CATEGORY_IGNORE_STR = ['독샤워 이벤트','교육 상품','도매 사업체 상품']
		...
		self.C_PAGE_TYPE = ''
		self.C_PAGE_VALUE = '#contents_main > div.contents_inner > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > ol > li > a'
		...
		#self.C_PRODUCT_VALUE = '#contents_main > div.contents_inner > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li > div.description > strong > a'
		
		self.C_PRODUCT_VALUE = '#contents_main > div.contents_inner > div.xans-element-.xans-product.xans-product-normalpackage > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li'
		self.C_PRODUCT_STRIP_STR = ''
		
		# self.PAGE_LAST_LINK = True 일때 사용
		self.C_LAST_PAGE_CASE = __DEFINE__.__C_SELECT__
		self.C_LAST_PAGE_TYPE = ''
		self.C_LAST_PAGE_VALUE = '#contents_main > div.contents_inner > div.xans-element-.xans-product.xans-product-normalpaging.ec-base-paginate > a.last'
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#contents_main > div.contents_inner > div.xans-element-.xans-product.xans-product-detail > div.detailArea > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
