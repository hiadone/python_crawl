...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.C_PRODUCT_VALUE = '#sp-content > div.xans-element-.xans-product.xans-product-listnormal.sp-product > div > div.sp-product__box > div'
		...
		self.C_LAST_PAGE_VALUE = '#sp-content > div.xans-element-.xans-product.xans-product-normalpaging.sp-pagenation > ul.sp-pagenation--control > li > a'
