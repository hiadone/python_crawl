...
class shop(Cafe24) :    
	...
	def get_product_detail_data(self, product_data, html):
		...
		try :
			...
			table_list = soup.select('#layout-contents > div.layout-contents-wrap > div > div > div.xans-element-.xans-product.xans-product-image.imgArea > div.detail-right > div > div > div > div > div > div > div > div.infoArea > div.xans-element-.xans-product.xans-product-detaildesign > table')
			...
			# 제품 상세 부분			
			self.get_cafe24_text_img_in_detail_content_part( soup, product_data, '#layout-contents > div.layout-contents-wrap > div > div > div.xans-element-.xans-product.xans-product-image.imgArea > div.detail-center', '' )
