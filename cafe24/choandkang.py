...
class shop(Cafe24) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://choandkang.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['동네 고양이']
		...
		#self.C_PRODUCT_VALUE = '#contents > div.xans-element-.xans-product.xans-product-normalpackage.cateNormPrd > div.xans-element-.xans-product.xans-product-listnormal.ec-base-product > ul > li > div.description > div.name > a'
