...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.biteme.co.kr'
		...
		#self.C_PRODUCT_VALUE = '#contents > div > div > div.goods_list_item > div.goods_list > div > div > ul > li > div > div.item_info_cont > div.item_tit_box > a'
		self.C_PRODUCT_VALUE = '#contents > div > div > div.goods_list_item > div.goods_list > div > div > ul > li'
		...
		self.BASIC_CATEGORY_URL = self.SITE_HOME + '/goods/' 	
