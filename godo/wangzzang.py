...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.wangzzang.com'
		...
		self.C_CATEGORY_VALUE = '#header > div.navbar-frame.navbar_large > div > div > div.sub_menu_box.layer_type > ul > li > a'
		self.C_CATEGORY_IGNORE_STR = ['브랜드','커뮤니티']				# 
		...
		self.C_PAGE_TYPE = ''
		self.C_PAGE_VALUE = '#contents > div > div > div > div.pagination > div > ul > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div > div > div > div.goods_list > div > div > ul > li > div'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div > div > div > div.pagination > div > ul > li.btn_page.btn_page_last > a'
		...
		self.SET_PRODUCT_DATA_CATEGORY_TEXT_SELECTOR = 'h2'
