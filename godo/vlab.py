...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'https://www.vlab.kr'
		...
		self.C_CATEGORY_VALUE = '#comment_top > div > div.top_cate > div > div > div.gnb_menu_box > ul > li > ul > li > a'
		self.C_CATEGORY_VALUE_2 = '#comment_top > div > div.top_cate > div > div > div.gnb_menu_box > ul > li > a'
		...
		self.C_PAGE_TYPE = ''
		self.C_PAGE_VALUE = '#contents > div > div > div.goods_list_item > div.pagination.width1260 > div > ul > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div > div > div.goods_list_item > div.goods_list.width1260 > div > div.item_gallery_type > ul > li'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div > div > div.goods_list_item > div.pagination.width1260 > div > ul > li.btn_page.btn_page_last > a'
