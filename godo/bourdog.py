...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://bourdog.com'
		...
		self.C_PAGE_VALUE = '#contents > div.sub_content > div > div.goods_list_item > div.pagination > div > ul > li > a'
		...
		self.C_PRODUCT_VALUE = '#contents > div.sub_content > div > div.goods_list_item > div.goods_list > div > div > ul > li > div'
		...
		self.C_LAST_PAGE_VALUE = '#contents > div.sub_content > div > div.goods_list_item > div.pagination > div > ul > li.btn_page.btn_page_last > a'
