...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.C_PAGE_TYPE = ''
		self.C_PAGE_VALUE = '#contents > div > div > div.left_content > div > div.pagination > div > ul > li > a'
		...
		#self.C_PRODUCT_VALUE = '#contents > div > div > div.left_content > div > div.goods_list > div > div > ul > li > div > div.item_info_cont > div.item_tit_box > a'
		self.C_PRODUCT_VALUE = '#contents > div > div > div.left_content > div > div.goods_list > div > div > ul > li > div'
		self.C_PRODUCT_STRIP_STR = '..'
		
		# self.PAGE_LAST_LINK = True 일때 사용
		self.C_LAST_PAGE_CASE = __DEFINE__.__C_SELECT__
		
		self.C_LAST_PAGE_TYPE = '#contents > div > div > div.left_content > div > div.pagination > div > ul > li.btn_page.btn_page_last > a'
