...
# 대상 사이트 : http://www.diditable.com

# 특이 사항

		- 웹페이지 encoding : 
		
		- 특정 카테고리만 : 강아지, 고양이 모두있음 / [DOG Food] 카테고리만 노출 
...
class shop(GodoMall) :    
	...
	def __init__(self) :
		...
		self.SITE_HOME = 'http://www.diditable.com'
		...
		self.C_CATEGORY_IGNORE_STR = ['CAT FOOD','공지사항','상품후기','상품문의','FAQ']				# DOG FOOD 만 갖고오기 위해서
		...
		self.SET_PRODUCT_DATA_CATEGORY_CLASS_NAME = 'goods_category_name'
