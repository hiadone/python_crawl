...
class shop(Mall) :    
	...
	def __init__(self) :
		...
		self.C_CATEGORY_VALUE = '#big_section > ul.midcate > li > a'		# 미들 카테고리
		...
		self.BASIC_CATEGORY_URL = 'https://www.smallstuff.kr'
		self.BASIC_PAGE_URL = 'https://www.smallstuff.kr'
		self.BASIC_PRODUCT_URL = 'https://www.smallstuff.kr'
		self.BASIC_IMAGE_URL = 'https://www.smallstuff.kr'
